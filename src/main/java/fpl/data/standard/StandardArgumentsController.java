...
public class StandardArgumentsController {
	...
	@GetMapping("/fpl/data/standard/request")
	...
	@PostMapping("/fpl/data/standard/request/reader")
	...
	@PostMapping("/fpl/data/standard/request/is")
	...
	@GetMapping("/fpl/data/standard/response")
	public String response(HttpServletResponse response) {
		return "response = " + response;
	}

	@GetMapping("/fpl/data/standard/response/writer")
	...
	@GetMapping("/fpl/data/standard/response/os")
	...
	@GetMapping("/fpl/data/standard/session")
